...
| **3** | **Weekly Weekday Demo Cadence (4 Demos / Month)**<br>*KPI: 2 Learning Suite demos (Yashvi), 2 Sales Suite demos (Prakhar)* | **C2: Product & Demo** | Yashvi *(Learning)*<br>Prakhar *(Sales)* | **Weekly (W1–W4)** | Sprint 1, 2, 3, 4 | `[ ] Planned` | - | None | 🟢 |
